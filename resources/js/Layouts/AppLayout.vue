...
<!--                    &lt;!&ndash; Right Section: Teams & Settings Dropdowns &ndash;&gt;-->
...
<!--        </nav>-->
        <div class="google-doc-nav bg-white dark:bg-gray-900">
            ...
            <div>
                <!-- Placeholder for Google Doc logo -->
...
<style>
    ...
    .search-input {
        ...
        margin: 0 20px; /* Space around input */
        padding: 5px;
    ...
    .profile-picture {
        ...
        height: 40px; /* Fixed size for profile picture */
    ...
    nav {
        ...
        height: 100%;
        padding-top: 50px;
        z-index: 0; /* Ensure the nav is below the toggle */
    }
